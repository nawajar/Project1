...
<h1 align="left"><span class="style3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="style3"><img src="fselogocolor.png" width="128" height="122" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><img src="images/haeder.png" width="492" height="117" /><br />
  ...
  <div id="sidebar1">
    ...
    <img src="images/mrtg.png" width="180" height="22" /><img src="images/iconcontrol/activity_monitor.png" width="23" height="29" /> <a href="mrtg.php?locate=1" class="style14">โรงอาหาร</a><br />
              <img src="images/iconcontrol/activity_monitor.png" width="23" height="29" /> <a href="mrtg.php?locate=2" class="style14">อาคารเรียนรวม<br />
              <br />
    ...
    <h3><img src="images/administrator.png" width="176" height="26" /><img src="images/iconcontrol/add_admin.png" width="27" height="26" /> <a href="name_admin.php" class="style20">ผู้ดูแลระบบ</a><br />
      <img src="images/iconcontrol/add_admin.png" alt="" width="27" height="26" /> <a href="add_admin.php" class="style14"><strong>เพิ่มผู้ดูแลระบบ</strong></a><br />
    </h3>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
...
&nbsp;&nbsp;&nbsp;<br />
    ...
    <p class="style11">&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<span class="style21">รายชื่อผู้ดูแลระบบ /  administrator</span></p>
	...
	$strSQL = "SELECT * FROM admin WHERE status = ";
	$strSQL .= "'".$stat."'";
	$strSQL .= "ORDER BY Admin_id ASC";
	...
	<td><?=$objResult["Username"]; //get ip from db?></td>
	<td><?=$objResult["Password"]; //get ip from db?></td>
	<td><?=$objResult["Name"]; //get physical address from db?></td>
	<td><a href="/project1/deladmin.php?user=<?=$objResult["Username"];?>"><img src="/project1/images/trash.png" onclick="return confirmation();" alt="Smiley face" height="16" width="16"></a></td>
