...
<title>อาคารเรียนรวม</title>
<link href="/project1/menu_assets/styles.css" rel="stylesheet" type="text/css">
<style type="text/css"> 
<!-- 
#chart{
		background: url(images/zone_2.jpg) no-repeat left top;
...
<h1 align="left"><span class="style3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="fselogocolor.png" width="128" height="122" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/haeder.png" width="492" height="117" /></span><br />
  ...
  <div id="mainContent">
    <h1 align="left" class="style11">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/อาคาร2.png" width="379" height="166" /><br />
    </h1> 
  ...
  for($j=0; $j<=$s; $j++){
   ...
   for($t=0; $t<=18; $t++){
	   ...
	   for($u=0; $u<=18; $u++){
		...
		if( (($t >=1 && $t <=1) && ($u >= 0 && $u <= 0)) || (($t >=0 && $t <=0) && ($u >= 0 && $u <= 2)) || (($t >=0 && $t <=0) && ($u >= 15 && $u <= 15)) || (($t >=0 && $t <=1) && ($u >= 16 && $u <= 16)) || (($t >=0 && $t <=1) && ($u >= 17 && $u <= 17)) || (($t >=0 && $t <=2) && ($u >= 18 && $u <= 18)) || (($t >=17 && $t <=18) && ($u >= 0 && $u <= 2)) || (($t >=17 && $t <=18) && ($u >= 15 && $u <= 18)) || (($t >=16 && $t <=18) && ($u >= 17 && $u <= 18))   ){
         $dis[$t][$u] = -1;
		}
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 1 Cell : 36 ตารางเมตร 
<!--  <div id="Txt" style="width:100px;height:50px;border:solid black 1px;" >x : 0 </div>
...
$Y = array();
 ...
 $y++;
	...
	?>
    	...
    	<span class="style19"><span class="style24">แผนผังแสดงจุดติดตั้งของอุปกรณ์และค่าความเข้มของสัญญาณ  <strong>Access Point</strong></span><br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    <span class="style22">(สีแดง)  </span>     ไม่มีอุปกรณ์ติดตั้ง    </span> 
        <p>
      <!-- end #mainContent -->
    </p>
    <p>&nbsp;</p>
