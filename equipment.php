<?php
//validate if not login
@session_start();
if(@$_SESSION["sesID"] != session_id()){
//redirect to login page and show message errror
header("Location:/project1/admin.php?error=Please login!");
}
//get parameter for refresh page 
$locate = $_GET["locate"];
echo "<META HTTP-EQUIV=Refresh CONTENT='5; URL=equipment.php?locate=$locate'>"; 
...
<h1 align="left"><span class="style3">&nbsp;&nbsp;&nbsp; </span><span class="style3"><img src="fselogocolor.png" width="128" height="122" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><img src="images/haeder.png" width="492" height="117" /><br />
  ...
  <div id="sidebar1">
    <h3><img src="images/zone.png" alt="zone" width="180" height="24" align="left" /><br />
      ...
      <img src="images/iconcontrol/onebit_24.png" alt="" width="30" height="32" /> <a href="zone.php?id=2" class="style14">อาคารเรียนรวม</a><br />
      <br />
      ...
      <a href="#" class="style14"><img src="images/ติดตาผู้ใช้งาน.png" alt="" width="26" height="28" />อาคารเรียนรวม</a><br />
      <br />
      <img src="images/สถานะอุปกรณ์.png" width="179" height="21" /><img src="images/iconcontrol/admin.png" width="26" height="28" /> <a href="online.php?locate=1" class="style14">โรงอาหาร</a><br />
      <img src="images/iconcontrol/admin.png" alt="" width="26" height="28" /> <a href="online.php?locate=2" class="style14">อาคารเรียนรวม</a></h3>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
 ...
 <h3>Administrator Page</h3>
	...
	$strSQL = "SELECT * FROM equipment WHERE Location_id = ";
	$strSQL .= "'".$_GET["locate"]."'";
    ...
    ?> 
	<p><a href="/project1/addequip.php?back=<?=$_GET["locate"];?>">Add Equipment</a></p>
	<table  class="general">
	<tr class="head">
	<td>id</td>
	<td>Ip Add</td>
	...
	?>
    <tr> 
	<td><?  echo $i++; //index of item in table?></td>
	<td><?=$objResult["Ip_address"]; //get ip from db?></td>
	<td><?=$objResult["Physical_address"]; //get physical address from db?></td>
	<td>
	<? 
	//check device is avalible? 
	...
	<td align="center"><a href="/project1/graph.php?id=<?=$objResult["Equipment_id"];?>"><img src="/project1/images/diagram.png" alt="Smiley face" height="16" width="16"></a></td>
	<td align="center"><a href="/project1/equipedit.php?id=<?=$objResult["Equipment_id"];?>&back=<?=$_GET["locate"];?>"><img src="/project1/images/user_edit.png" alt="Smiley face" height="16" width="16"></a></td>
	<td align="center"><a href="/project1/equipdel.php?id=<?=$objResult["Equipment_id"];?>&back=<?=$_GET["locate"];?>"><img src="/project1/images/trash.png" onclick="return confirmation();" alt="Smiley face" height="16" width="16"></a></td>
    </tr>	
	<? 
	}
