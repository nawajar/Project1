...
<div id="container">
  <div id="header">
<h1 align="left"><span class="style3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="style20"><img src="fselogocolor.png" width="128" height="122" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><img src="images/haeder.png" width="492" height="117" /><br />
    </h1>
  ...
  <img src="images/iconcontrol/onebit_24.png" alt="" width="30" height="32" /> <a href="zone_.php?id=2" class="style14">อาคารเรียนรวม</a><br />
    ...
    <img src="images/สถานะอุปกรณ์.png" width="179" height="22" /><img src="images/iconcontrol/admin.png" width="26" height="28" /> <a href="online.php?locate=1" class="style14">โรงอาหาร</a><br />
  ...
  <div id="mainContent">
    ...
    <p><img src="images/iconcontrol/login-icon.jpg" width="102" height="102" /> Welcome : <font color="blue">
	<? 
	/*Check user login? if not go to manage.php */
	...
	<table>
	<tr><td colspan='2'><font color='red'><? if(@$_GET["error"] != null){echo "**".$_GET["error"];} ?></font></td></tr>
	...
	<? 
     ...
     /* if user login then disable submit button prevent duplicate login */
     if(@$_SESSION["sesID"] == session_id())
	 {
       ?>
    ...
    <h1 align="left" class="style11"><br />
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
  &nbsp;&nbsp;&nbsp;<br />
    </h1>
    <p class="style11">&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;</p>
